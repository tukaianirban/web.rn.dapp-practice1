...
const Services = () => {
    return (
        // flex-col for any device and flex-row for md and larger devices
        <div className='flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services'>

            {/* the heading of services section */}
            <div className='flex mf:flex-row flex-col items-center jusitfy-between md:p-20 py-12 px-4'>
